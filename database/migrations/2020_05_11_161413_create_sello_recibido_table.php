...
class CreateSelloRecibidoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sello_recibido', function (Blueprint $table) {
            $table->bigIncrements('id');

            $table->string('identificador');
            $table->date('fyh_quitado');
    ...
    {
        Schema::dropIfExists('sello_recibido');
    }
}
