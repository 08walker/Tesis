...
@section('meta-title','Tesis| Tipos de equipos')
@section('meta-description','Listado de Tipos de equipos')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tipos de equipos</h1>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
...
<div class="content">
        ...
        <div class="card">
            <div class="card-header">
              ...
              @can('create',new \App\TipoEquipo) 
              <a href="{{route('tipoequipo.create')}}" type="button" class="btn btn-primary btn-flat" >
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  @can('update',new \App\TipoEquipo) 
                  <td>
                        {{-- <a href="{{route('tipoequipo.show',$tipo)}}" target="_blank">
                          <i class="fa fa-eye"></i>
                        </a> --}}
