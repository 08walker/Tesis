  ...
  <!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          ...
          <div class="col-sm-10">
            <h1 class="m-0 text-dark"> Reporte #6 Comportamiento de la utilización de equipos de la empresa.</h1>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="row">
          ...
          <div class="card card-primary card-outline">
              <div class="card-body">
              <form id="quickForm" role="form" method="POST" action="{{ route('reportes.reporte6filtrado') }}">
                  {!! csrf_field() !!}
                  <div class="container">
                    <div class="row">
                      <div class="col-md-6">
