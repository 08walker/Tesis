  ...
  <!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          ...
          <div class="col-sm-10">
            <h1 class="m-0 text-dark"> Reporte #8 Filtrar transportaciones por envases.</h1>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="row">
          ...
          <div class="card card-primary card-outline">
              <div class="card-body">
              <form id="quickForm" role="form" method="POST" action="{{ route('reportes.reporte8filtrado') }}">
                  {!! csrf_field() !!}
                  <div class="container">
                    <div class="row">
                      <div class="col-md-6">
            ...
            <div class="col-md-8">
              <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                  ...
                  @include('componentes.callouttranspmini',['model'=>$demo->transportaciones])
                  @foreach($demo->transportaciones->transfenviada as $demo2)
