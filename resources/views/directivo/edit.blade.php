...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Actualizar Directivo</h1>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="card card-primary card-outline">
                  <div class="card-body">
                    ...
                    <div class="card-body">
                      ...
                      @include('foreach.organizacionfor',['model'=>$directivo])

                    <button type="submit" class="btn btn-success btn-flat">Actualisar</button>
                    <a class="btn btn-flat btn-primary" href="{{route('directivo.index')}}">Cancelar</a>
                    </div>
                </form>                
                </div>
                </div>
